...
//            bytes[j][240 * 72 + 8 + 4 - 1] = 0x00;
    ...
    public static byte[] requestUpdateFW() {
        // 请求进入download mode，更新固件
    ...
    public static byte[] getFirstFrame() {
    ...
    public static byte[] getStartFrame() {
        byte[] bytes = new byte[192];
        bytes[0] = 0x01;
        bytes[1] = 0x00;
        bytes[2] = (byte) 0xff;
        bytes[3] = Byte.parseByte("a");
        bytes[4] = Byte.parseByte("p");
        bytes[5] = Byte.parseByte("p");
        bytes[6] = Byte.parseByte(".");
        bytes[7] = Byte.parseByte("b");
        bytes[8] = Byte.parseByte("i");
        bytes[9] = Byte.parseByte("n");
